<script lang="ts">
	import { Swordsman, Knight, Barbarian, Monk } from '$lib/Classes/Martial';

	const classes = { Swordsman, Knight, Barbarian, Monk };
	let selected: keyof typeof classes = 'Swordsman';
